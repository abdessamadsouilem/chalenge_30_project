...
export default restart => {
    ...
    return {
        ...
        Bird: Bird(world, 'black', { x: 50, y: 300 }, { width: 50, height: 50 }),
        Floor: Floor(world, 'green', { x: windowWidth / 2, y: windowHeight }, { width: windowWidth, height: 100 }),

        ObstacleTop1: Obstacle(world, 'ObstacleTop1', 'red', pipeSizePosA.pipeTop.pos, pipeSizePosA.pipeTop.size),
        ObstacleBottom1: Obstacle(world, 'ObstacleBottom2', 'blue', pipeSizePosA.pipeBottom.pos, pipeSizePosA.pipeBottom.size),
